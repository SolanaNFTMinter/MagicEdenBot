...
1. Clone the repository / Download zip file
    ...
    `git clone https://github.com/SolanaNFTMinter/MagicEdenBot.git`

    OR

    [Download Zip File](https://github.com/SolanaNFTMinter/MagicEdenBot/archive/refs/heads/main.zip)
